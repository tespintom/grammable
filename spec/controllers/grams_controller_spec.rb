...
RSpec.describe GramsController, type: :controller do
  describe 'grams#destroy action' do
    it 'shoult not allow user who didnt crate the gram to destory it' do
    ...
    it 'should not let unauthenticated user detroy a gram' do
      gram = FactoryBot.create(:gram)
      delete :destroy, params: { id: gram.id }
  ...
  describe 'grams#edit action' do
    it 'should not let user who did not create the gram edit a gram' do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe 'grams#show action' do
    ...
    it 'should return a 404 error if th gram is not found' do
  ...
  describe 'grams#create action' do
    ...
    it 'should properly deal with validation erros' do
      user = FactoryBot.create(:user)
      sign_in user
